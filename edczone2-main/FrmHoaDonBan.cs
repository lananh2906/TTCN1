...
namespace EDCZONE
{
    public partial class FrmHoaDonBan : Form
    {
        ...
        {
            string sql;
            sql = "SELECT a.MaSP, b.TenSP, a.SoLuong, b.DonGia,a.DVT, a.GiamGia,a.ThanhTien FROM tblchitiethoadonban AS a, tblsanpham AS b WHERE  a.MaSP=b.MaSP";
        ...
        private void btnLuuHD_Click(object sender, EventArgs e)
        {
            ...
            if (!Functions.CheckKey(sql))
            {
             ...
             sql = "INSERT INTO tblhoadonban(MaHDB, MaKH, MaNV, NgayBan, TongTien) VALUES (N'" + txtSoHDB.Text.Trim() + "','" + cboMaKhach.SelectedValue + "'," + cboMaNV.SelectedValue + "',N'" +
                        dtpNgayBan.Value + "',N'" + txtTongTien.Text + ")";
